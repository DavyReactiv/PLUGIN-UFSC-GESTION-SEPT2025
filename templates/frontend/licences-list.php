            ...
            <div class="ufsc-card ufsc-licence-card">
                ...
                <div class="ufsc-licence-actions">
                    ...
                    <?php elseif ( ! $renew_open ) : ?>
                        <span class="ufsc-text-muted" title="<?php esc_attr_e( 'Le renouvellement n\'est pas encore ouvert.', 'ufsc-clubs' ); ?>"><?php echo esc_html( sprintf( __( 'Renouvellement %1$s ouvert à partir du %2$s', 'ufsc-clubs' ), $next_season, $renew_open_label ) ); ?></span>
                    <?php endif; ?>
                    <?php if ( ! $is_locked ) : ?>
