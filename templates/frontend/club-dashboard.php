...
$affiliation_next  = function_exists( 'ufsc_get_affiliation_season' ) ? ufsc_get_affiliation_season( $club->id, $current_season ) : '';
$affiliation_done  = function_exists( 'ufsc_is_club_affiliated_for_season' ) ? ufsc_is_club_affiliated_for_season( $club->id, $current_season ) : ( $affiliation_next === $current_season );
        ...
        <div class="ufsc-grid ufsc-actions-grid">
            ...
            <div class="ufsc-card">
                ...
                <?php elseif ( ! $renew_window_open ) : ?>
                    <span class="ufsc-text-muted"><?php echo esc_html( sprintf( __( 'Renouvellement %1$s ouvert à partir du %2$s', 'ufsc-clubs' ), $current_season, $renew_open_label ) ); ?></span>
                <?php endif; ?>
            </div>
