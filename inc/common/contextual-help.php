...
function ufsc_contextual_help_map() {
    return array(
        ...
        'Statistiques' => __( 'Les statistiques de profil portent uniquement sur les licences officiellement validées pour la saison affichée. Les brouillons et dossiers en attente restent visibles dans le suivi, mais sont exclus des statistiques.', 'ufsc-clubs' ),
        'Profil des licenciés' => __( 'Cette répartition prend uniquement en compte les licences validées UFSC. Si aucune licence n’est encore validée, les compteurs restent volontairement à zéro.', 'ufsc-clubs' ),
