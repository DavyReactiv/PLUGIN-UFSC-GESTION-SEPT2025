...
class UFSC_Capabilities {
    ...
    const CAP_LICENCE_VALIDATE         = 'ufsc_licence_validate';
    ...
    const CAP_COMPETITION_VALIDATE     = 'ufsc_competition_validate';
    ...
    public static function register_caps() {
        ...
        $responsable_caps = array(
            ...
            self::CAP_LICENCE_VALIDATE     => true,
            ...
            self::CAP_COMPETITION_VALIDATE => true,
        );
