...
final class UFSC_FFST_Matrix_Export_Admin {
    ...
    private static function affiliation_row( $club ) {
        ...
        foreach ( array( 'president', 'secretaire', 'tresorier', 'entraineur' ) as $prefix ) { $row[] = self::value( $club, array( $prefix . '_nom' ) ); $row[] = self::value( $club, array( $prefix . '_prenom' ) ); $row[] = self::value( $club, array( $prefix . '_date_naissance' ) ); $row[] = self::value( $club, array( $prefix . '_ville_naissance' ) ); $row[] = self::join_non_empty( array( self::value( $club, array( $prefix . '_departement_naissance' ) ), self::value( $club, array( $prefix . '_pays_naissance' ) ) ), ' / ' ); $row[] = self::value( $club, array( $prefix . '_pere_nom_prenom' ) ); $row[] = self::value( $club, array( $prefix . '_mere_nom_prenom' ) ); $row[] = self::value( $club, array( $prefix . '_adresse' ) ); $row[] = self::value( $club, array( $prefix . '_complement_adresse' ) ); $row[] = self::value( $club, array( $prefix . '_code_postal' ) ); $row[] = self::value( $club, array( $prefix . '_ville' ) ); $row[] = self::value( $club, array( $prefix . '_tel', $prefix . '_telephone' ) ); $row[] = self::value( $club, array( $prefix . '_email' ) ); }
        for ( $i = 0; $i < 13; $i++ ) { $row[] = ''; }
