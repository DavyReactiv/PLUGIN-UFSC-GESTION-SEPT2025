...
class UFSC_CL_Admin_Menu {
	...
	public static function render_dashboard() {
		...
		if ( ufsc_user_can( UFSC_Permissions::CAP_GESTION_MANAGE ) ) {
			...
			echo '<a href="' . esc_url( admin_url( 'admin.php?page=ufsc_lc_licences&action=new' ) ) . '" class="button button-primary">' . esc_html__( 'Nouvelle Licence', 'ufsc-clubs' ) . '</a>';
			echo '<a href="' . esc_url( admin_url( 'admin.php?page=ufsc-sql-clubs' ) ) . '" class="button">' . esc_html__( 'Gérer les Clubs', 'ufsc-clubs' ) . '</a>';
			echo '<a href="' . esc_url( admin_url( 'admin.php?page=ufsc_lc_licences' ) ) . '" class="button">' . esc_html__( 'Gérer les Licences', 'ufsc-clubs' ) . '</a>';
