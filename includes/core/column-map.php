...
class UFSC_Column_Map {
    ...
    public static function get_default_licences_columns() {
        return array(
            ...
            'poids'                       => 'poids',
            'categorie_age_detectee'      => 'categorie_age_detectee',
            'categorie_poids_detectee'    => 'categorie_poids_detectee',
            'categorie_updated_at'        => 'categorie_updated_at',
            'email'                       => 'email',
            'adresse'                     => 'adresse',
...
function ufsc_get_mapped_column_if_exists( $table_name, $logical_key, $table_type ) {
    ...
    $mapped_column = ( $table_type === 'clubs' )
        ? ufsc_club_col( $logical_key )
        : ufsc_lic_col( $logical_key );
