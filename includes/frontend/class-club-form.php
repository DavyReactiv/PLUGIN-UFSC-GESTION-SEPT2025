...
class UFSC_CL_Club_Form {
    ...
    public static function render_shortcode( $atts ) {
        ...
        // check if user already has a club, so he can't create another club
        // Users may create only one club. If the current user already
        $existing_club_id = UFSC_User_Club_Mapping::get_user_club_id(get_current_user_id());
         if ($existing_club_id) {
            ufsc_club_redirect_cart($existing_club_id);   
                  
            return '<div class="ufsc-alert error">' . 
                   esc_html__( 'La gestion de plusieurs clubs n’est pas autorisée. Vous avez déjà créé un club.', 'ufsc-clubs' ) . 
                   '</div>';
        }
                    ...
                    ?>
                        <div class="ufsc-dirigeant-section">
                            ...
                            <div class="ufsc-field">
                                ...
                                <input type="text" id="<?php echo esc_attr( $dirigeant ); ?>_tel" name="<?php echo esc_attr( $dirigeant ); ?>_tel" value="<?php echo esc_attr( $club_data[ $dirigeant . '_tel' ] ?? '' ); ?>" <?php echo $info['required'] ? 'required' : ''; ?> />
                                <div class="ufsc-field-error" aria-live="polite"></div>
                            </div>

                            <div class="ufsc-field">
                                <label for="<?php echo esc_attr( $dirigeant ); ?>_date_naissance" class="ufsc-label <?php echo $info['required'] ? 'required' : ''; ?>"><?php esc_html_e( 'Date de naissance', 'ufsc-clubs' ); ?></label>
                                <input type="date" id="<?php echo esc_attr( $dirigeant ); ?>_date_naissance" name="<?php echo esc_attr( $dirigeant ); ?>_date_naissance" value="<?php echo esc_attr( $club_data[ $dirigeant . '_date_naissance' ] ?? '' ); ?>" <?php echo $info['required'] ? 'required' : ''; ?> />
                                <div class="ufsc-field-error" aria-live="polite"></div>
                            </div>

                            <div class="ufsc-field">
                                <label for="<?php echo esc_attr( $dirigeant ); ?>_adresse" class="ufsc-label <?php echo $info['required'] ? 'required' : ''; ?>"><?php esc_html_e( 'Adresse', 'ufsc-clubs' ); ?></label>
                                <input type="text" id="<?php echo esc_attr( $dirigeant ); ?>_adresse" name="<?php echo esc_attr( $dirigeant ); ?>_adresse" value="<?php echo esc_attr( $club_data[ $dirigeant . '_adresse' ] ?? '' ); ?>" <?php echo $info['required'] ? 'required' : ''; ?> />
                                <div class="ufsc-field-error" aria-live="polite"></div>
                            </div>

                             <div class="ufsc-field">
                                <label for="<?php echo esc_attr( $dirigeant ); ?>_poste" class="ufsc-label <?php echo $info['required'] ? 'required' : ''; ?>"><?php esc_html_e( 'Poste', 'ufsc-clubs' ); ?></label>
                                <input type="text" id="<?php echo esc_attr( $dirigeant ); ?>_poste" name="<?php echo esc_attr( $dirigeant ); ?>_poste" value="<?php echo esc_attr( $club_data[ $dirigeant . '_poste' ] ?? '' ); ?>" <?php echo $info['required'] ? 'required' : ''; ?> />
                                <div class="ufsc-field-error" aria-live="polite"></div>
                            </div>
