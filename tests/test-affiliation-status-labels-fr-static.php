...
$assert( false === strpos( $labels, '$wpdb->update' ), 'presentation labels must not mutate database state' );
$assert( false === strpos( $labels, '$wpdb->delete' ), 'presentation labels must not delete data' );
