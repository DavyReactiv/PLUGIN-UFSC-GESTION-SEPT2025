...
$assert( strpos( $files['woo'], "'product_affiliation_id'  => 0" ) !== false, 'No affiliation product ID may be hard-coded.' );
foreach ( array( 'missing_product_id', 'product_not_found', 'product_not_published', 'product_hidden', 'product_without_price', 'product_not_purchasable' ) as $reason ) {
