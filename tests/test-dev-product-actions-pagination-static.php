...
$assert( false !== strpos( $front, 'Le produit Licence UFSC n’est pas configuré. Contactez l’administration.') && false !== strpos( $front, 'data-ufsc-cart-ready=') && false !== strpos( $front, 'disabled( ! $product_ready )'), 'cart action always rendered with unavailable explanation' );
