...
$assert( false !== strpos( $module, "'.ufsc-demographic-summary{display:none!important}'" ) || false !== strpos( $module, '.ufsc-demographic-summary{display:none!important}' ), 'Misleading legacy demographic panel must be hidden when v2 is present.' );
$assert( false !== strpos( $module, "false !== strpos( $output, 'ufsc-stats-v2' )" ), 'Legacy profile must only be hidden when replacement v2 stats are present.' );
