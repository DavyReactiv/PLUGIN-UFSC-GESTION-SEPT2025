<?php
/** Static safeguards for contextual help and validated-only profile statistics. */
...
$assert(
    false !== strpos( $module, "'Statistiques'" )
    && false !== strpos( $module, 'licences officiellement validées' )
    && false !== strpos( $module, 'brouillons et dossiers en attente' )
    && false !== strpos( $module, 'exclus des statistiques' ),
    'Statistics help must clearly state validated-only scope and exclusion of drafts/pending dossiers.'
);
$assert( false !== strpos( $module, "'Profil des licenciés'" ) && false !== strpos( $module, 'uniquement en compte les licences validées UFSC' ), 'Profile help must remain validated-only.' );
