...
jQuery(document).ready(function($) {
    ...
    function initImportExport() {
        ...
        // CSV import preview
        $("#ufsc-import-modal .ufsc-import-form").submit(function(e){
            e.preventDefault();
    ...
    function showImportPreview(data) {
        ...
        if (data.preview && data.preview.length > 0) {
            ...
            previewHtml += '<th>' + ufsc_frontend_vars.strings.tel_mobile + '</th>';
            previewHtml += '<th>' + ufsc_frontend_vars.strings.date_naissance + '</th>';
            previewHtml += '<th>' + ufsc_frontend_vars.strings.sexe + '</th>';
            previewHtml += '<th>' + ufsc_frontend_vars.strings.adresse + '</th>';
            previewHtml += '<th>' + ufsc_frontend_vars.strings.ville + '</th>';
            previewHtml += '<th>' + ufsc_frontend_vars.strings.code_postal + '</th>';
            previewHtml += '<th>' + ufsc_frontend_vars.strings.region + '</th>';
            ...
            data.preview.forEach(function(row) {
                ...
                previewHtml += '<td>' + (row.tel_mobile || '') + '</td>';
                previewHtml += '<td>' + (row.date_naissance || '') + '</td>';
                previewHtml += '<td>' + (row.sexe || '') + '</td>';
                previewHtml += '<td>' + (row.adresse || '') + '</td>';
                previewHtml += '<td>' + (row.ville || '') + '</td>';
                previewHtml += '<td>' + (row.code_postal || '') + '</td>';
                previewHtml += '<td>' + (row.region || '') + '</td>';
